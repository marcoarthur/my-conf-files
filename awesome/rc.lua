...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "g", function () awful.spawn(chrome) end,
              {description = "open chrome window", group = "launcher"}),

    awful.key({ modkey,           }, "v", function () awful.spawn(vim) end,
              {description = "open vim window", group = "launcher"}),

    awful.key({ modkey,           }, "i", function () awful.spawn(sc) end,
